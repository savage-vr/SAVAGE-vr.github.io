  ...
  return (
    <div className="relative flex items-center justify-center z-10">
      <svg id="logo" width="500" height="500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 595.28 841.89">
        ...
        <g>
          <polygon className="cls-3" points="309.71 242.69 329.57 242.69 405.44 318.55 385.57 318.55 309.71 242.69" />
          <polygon className="cls-3" points="310.12 341.35 329.11 341.35 404.98 417.22 385.99 417.22 310.12 341.35" />
